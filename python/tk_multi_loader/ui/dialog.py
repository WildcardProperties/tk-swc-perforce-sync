...
" }")
        ...
        self.fix_files = QtGui.QToolButton(Dialog)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.fix_files.sizePolicy().hasHeightForWidth())
        self.fix_files.setSizePolicy(sizePolicy)
        self.fix_files.setMinimumSize(QtCore.QSize(100, 26))
        self.fix_files.setObjectName("fix_files")
        ...
        self.publish_files = QtGui.QToolButton(Dialog)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.publish_files.sizePolicy().hasHeightForWidth())
        self.publish_files.setSizePolicy(sizePolicy)
        self.publish_files.setMinimumSize(QtCore.QSize(100, 26))
        self.publish_files.setObjectName("publish_files")
        self.publish_files.hide()
        ...
        self.horizontalLayout_4.addWidget(self.fix_files)
        self.horizontalLayout_4.addWidget(self.sync_files)
        self.horizontalLayout_4.addWidget(self.publish_files)
...
"")
        ...
        Dialog.setTabOrder(self.show_sub_items, self.fix_files)
        Dialog.setTabOrder(self.fix_files, self.sync_files)
        Dialog.setTabOrder(self.sync_files, self.publish_files)
        Dialog.setTabOrder(self.publish_files, self.thumb_scale)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.fix_files.setToolTip(QtGui.QApplication.translate("Dialog", "Send unpublished depot files to the Shotgrid Publisher.", None, QtGui.QApplication.UnicodeUTF8))
        self.fix_files.setText(QtGui.QApplication.translate("Dialog", "Fix Files", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.publish_files.setText(QtGui.QApplication.translate("Dialog", "Publish", None, QtGui.QApplication.UnicodeUTF8))
