...
" }")
        ...
        self.fix_files.setMaximumSize(QtCore.QSize(100, 26))
...
"")
        ...
        Dialog.setTabOrder(self.sync_files, self.fix_files)
        Dialog.setTabOrder(self.fix_files, self.submit_files)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.fix_files.setToolTip(QtGui.QApplication.translate("Dialog", "Send checked files in the Submitted view to the Shotgrid Publisher.", None, QtGui.QApplication.UnicodeUTF8))
