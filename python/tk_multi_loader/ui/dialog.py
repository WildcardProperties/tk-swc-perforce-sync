...
" }")
        ...
        self.fix_files.setMinimumSize(QtCore.QSize(120, 26))
        ...
        self.get_latest_revision.setObjectName("get_latest_revision")
...
"")
        ...
        Dialog.setTabOrder(self.fix_files, self.get_latest_revision)
