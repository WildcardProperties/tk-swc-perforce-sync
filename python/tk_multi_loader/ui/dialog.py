...
" }")
        ...
        # self.left_area.addItem(spacerItem)
        # self.left_area.setStretch(1, 1)
        ...
        self.perforce_mode = QtGui.QToolButton(Dialog)
        self.perforce_mode.setMinimumSize(QtCore.QSize(26, 26))
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/res/mode_switch_card.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.perforce_mode.setIcon(icon3)
        ...
        self.submitted_mode = QtGui.QToolButton(Dialog)
        ...
        self.pending_mode = QtGui.QToolButton(Dialog)
        ...
        self.pending_scroll = QtWidgets.QScrollArea()
        ...
        self.middle_area.addWidget(self.pending_scroll)
        ...
        self.fix_seleted = QtGui.QToolButton(Dialog)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.fix_seleted.sizePolicy().hasHeightForWidth())
        self.fix_seleted.setSizePolicy(sizePolicy)
        self.fix_seleted.setMinimumSize(QtCore.QSize(100, 26))
        self.fix_seleted.setMaximumSize(QtCore.QSize(100, 26))
        self.fix_seleted.setObjectName("fix_seleted")

        self.fix_all = QtGui.QToolButton(Dialog)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.submit_files = QtGui.QToolButton(Dialog)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_4.addWidget(self.fix_seleted)
...
"")
        ...
        # self.middle_area.setStretch(1, 1)
        self.horizontalLayout_3.addLayout(self.middle_area)

        # Right area
        self.details_tab = QtGui.QTabWidget(Dialog)
        self.details_tab.setObjectName("tab_widget")

        # File details
        self.file_details = QtGui.QGroupBox(Dialog)
        self.file_details.setMinimumSize(QtCore.QSize(300, 0))
        self.file_details.setMaximumSize(QtCore.QSize(300, 16777215))
        ...
        Dialog.setTabOrder(self.sync_files, self.fix_seleted)
        Dialog.setTabOrder(self.fix_seleted, self.fix_all)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.fix_seleted.setToolTip(QtGui.QApplication.translate("Dialog", "Publish selected files in the Submitted view", None, QtGui.QApplication.UnicodeUTF8))
        self.fix_seleted.setText(QtGui.QApplication.translate("Dialog", "Fix Selected", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.sync_files.setText(QtGui.QApplication.translate("Dialog", "Sync", None, QtGui.QApplication.UnicodeUTF8))
